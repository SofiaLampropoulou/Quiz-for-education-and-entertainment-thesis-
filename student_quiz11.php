...
/*function showstudentquizes() {
    ...
    $.getJSON("api.php?c=allstudentquiz&id=" + studentId, (res) => {
        ...
        res.forEach(quiz => {
            ...
            $("#squiz").append(`
                <tr>
                    ...
                    <td>
                        <button onclick="setcompleted(${quiz.id}, ${quiz.completed}, ${studentId})"
...
function showstudentquizes() {
    const lessonId = <?php echo $_GET['id']; ?>;
...
// Function to toggle the completion status of a quiz
...
}*/showstudentquizes// Function to toggle the completion status of a quiz
function setcompleted(quizId, currentCompleted, studentId) {
    const newCompleted = currentCompleted ? 0 : 1; // Toggle the completion status
