...
function showstudentquizes() {
    const lessonId = <?php echo $_GET['id']; ?>; // Course ID
    ...
    $.getJSON("api.php?c=allstudentquiz&id=" + lessonId, (res) => {
        ...
        res.forEach(quiz => {
            ...
            const buttonText = quiz.completed ? "open" : "done";  // If completed, show "Done"
...
// Load the quizzes for the logged-in student in the current course
showstudentquizes();
</script>
