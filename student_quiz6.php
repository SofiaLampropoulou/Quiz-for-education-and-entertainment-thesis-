    ...
    $.getJSON("api.php?c=allstudentquiz&id=" + id, (res) => {
        ...
        for (let i = 0; i < res.length; i++) {
            ...
            if (res[i].completed == 1) {
                doneMessage = "<span>Done</span>";  // Show 'Done' if the quiz is completed
            } else {
                buttonHtml = `<a href='game_squiz5.php?id=${res[i].id}'><button class='open-quiz'>Άνοιγμα</button></a>`; // Show 'Άνοιγμα' button
            }
